    ...
    <div className="group relative">
      ...
      >
        ...
        <div
          ...
          className="cursor-pointer rounded-md p-1 text-zinc-500 opacity-0 transition group-hover:opacity-100 hover:bg-zinc-200/50 dark:text-zinc-300 dark:hover:bg-zinc-700/60"
